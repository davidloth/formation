...
use Iad\TrainingBundle\Entity\Book;
use Iad\TrainingBundle\Form\BookType;
...
class BookController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('IadTrainingBundle:Book')->findAll();
     ...
     * @Method("POST")
     * @Template("IadTrainingBundle:Book:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('IadTrainingBundle:Book')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("IadTrainingBundle:Book:edit.html.twig")
     */
